...
//  Stocks
//
//  Created by Саид Дагалаев on 26.01.2020.
...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    private let companies: [String: String] = ["Apple": "AAPL", "Miscrosoft": "MSFT", "Google": "GOOG", "Amazon": "AMZN", "Facebook": "FB"]
    ...
    private func requestQuote(for symbol: String) {
        let url = URL(string: "https://cloud.iexapis.com/stable/stock/\(symbol)/quote/?token=sk_d46576cede54442f97b7119ecf1ae1e9")!
        
        let url2 = URL(string: "https://storage.googleapis.com/iexcloud-hl37opg/api/logos/\(symbol).png")!
